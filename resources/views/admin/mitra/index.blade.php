                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <select name="jenis_kemitraan" onchange="this.form.submit()"class="form-select">
                                        ...
                                        <option
                                            value="Platinum"{{ request('jenis_kemitraan') == 'Platinum' ? 'selected' : '' }}>
                                            Platinum</option>
                                        <option value="Gold"{{ request('jenis_kemitraan') == 'Gold' ? 'selected' : '' }}>
                                            Gold</option>
                                        <option
                                            value="Silver"{{ request('jenis_kemitraan') == 'Silver' ? 'selected' : '' }}>
                                            Silver</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    <select class="form-select" name='tanggal_bergabung' onchange="this.form.submit()">
                                        <option value="">Tahun Bergabung</option>
                                        @for ($i = 2024; $i >= 1900; $i--)
                                            <option value="{{ $i }}"
                                                {{ request('tanggal_bergabung') == $i ? 'selected' : '' }}>
                                                {{ $i }}</option>
                                        @endfor
                                    </select>
                                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif ($mitra->jenis_kemitraan == 'Gold')
                                        <span class="badge bg-warning text-dark">{{ $mitra->jenis_kemitraan }}</span>
                                ...
                                <td>
                                    <a href="{{ route('mitra.edit', $mitra->mitra_id) }}" class="btn btn-info btn-sm">
