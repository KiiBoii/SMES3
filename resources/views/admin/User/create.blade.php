...
{{--BREADCRUMB--}}
                ...
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item" aria-current="page"> <a
                                href="{{ route('User.list') }}">User </a></li>
                ...
                <form>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div><label for="name">First Name</label> <input class="form-control"
                                    id="name" name="name" type="text"
                                    placeholder="Masukkan Nama User" required=""></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div><label for="email">email</label> <input class="form-control" id="email"
                                    name="email" type="email" placeholder=". . . .d@gmaiil.com"
                                    required=""></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-group"><label for="Password">Password</label> <input class="form-control"
                                    id="Password" name="Password" type="password" placeholder="Password anda"
                                    required=""></div>
                        </div>
                        <div class="col-md-6 mb-3"><label for="role">Role User</label> <select
                            class="form-select mb-0" id="role" name="role"
        ...
        </div><button class="btn btn-gray-800 mt-2 animate-up-2" type="submit">Save all</button></div>
        </form>
        </div>
        {{--ENDFORM--}}
@endsection
